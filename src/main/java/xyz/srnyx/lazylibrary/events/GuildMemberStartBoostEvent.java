 ...
 */
public class GuildMemberStartBoostEvent extends GenericGuildMemberEvent {
    /**
     ...
     */
    public GuildMemberStartBoostEvent(@NotNull JDA api, long responseNumber, @NotNull Member member) {
     ...
     */
    public GuildMemberStartBoostEvent(@NotNull GuildMemberUpdateBoostTimeEvent event) {
